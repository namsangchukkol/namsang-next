    ...
    return (
        <main className="lg:m-indent md:m-indent-sm  m-indent-xsm">
            <section className="grid grid-cols-[1fr_3fr] justify-center items-center">
                <h2 className="text-3xl text-red-main">
                    {pageContent.title}
                </h2>
            ...
            <aside>
                ...
                >
                    {blogsContent?.map((blog, index) => (
                        <aside
                            key={index}
                            className={`grid col-span-1 first:grid-cols-1 first:row-span-3 row-span-${3 / (blogsLength - 1)
                                } sm:grid-cols-${blogsLength < 3 ? 1 : 2
                                } xl:grid-cols-[2fr_3fr] first:h-full h-[200px] 
                                             sm:grid-col-${gridConfig.card.grid_cols
                                } gap-3
                                            `}
                        >
                            <div
