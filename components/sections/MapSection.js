...
export default function MapSection() {
    ...
    return (
        <section className='relative bg-grey-light lg:h-[92vh] h-full w-screen'>
            ...
            <iframe
                src={currentField?.url || 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d62029.819385792944!2d100.58150050437015!3d13.666050043054742!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30e2a00bb218f43d%3A0x30100b25de25070!2sBang%20Na%2C%20Bangkok!5e0!3m2!1sen!2sth!4v1647601807711!5m2!1sen!2sth'}
                loading="lazy"
                ...
                {map?.locations?.map((location, index) =>
                    <button key={index}
                        className={`px-2 mx-2 h-10  
                                    ...
                                    ${currentIndex === index ? 'bg-red-main' : 'bg-grey-extralight'}
                                    `}
